...
import torch
import sys
sys.path.append('/home/admin1/all/DeepEIoU/DeepEIoU/tools')

from loguru import logger
from DeepEIoU.DeepEIoU.tools.yolox.data.data_augment import preproc
from DeepEIoU.DeepEIoU.tools.yolox.exp import get_exp
from DeepEIoU.DeepEIoU.tools.yolox.utils import fuse_model, get_model_info, postprocess
from DeepEIoU.DeepEIoU.tools.yolox.utils.visualize import plot_tracking
from DeepEIoU.DeepEIoU.tools.yolox.tracking_utils.timer import Timer
...
def imageflow_demo(predictor, extractor, vis_folder, current_time, args):
    ...
    if args.save_result:
        ...
        res_file = osp.join(vis_folder, f"{args.path.split('/')[-1][:-4]}.txt")
...
def main(exp, args):
    ...
    if not args.trt:
        if args.ckpt is None:
            ckpt_file = "/home/admin1/all/DeepEIoU/DeepEIoU/tools/checkpoints/best_ckpt.pth.tar"
        else:
            ckpt_file = args.ckpt
    ...
    extractor = FeatureExtractor(
        ...
        model_path = '/home/admin1/all/DeepEIoU/DeepEIoU/tools/checkpoints/sports_model.pth.tar-60',
        device='cuda'
    )   
